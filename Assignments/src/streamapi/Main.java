...
public class Main {
    public static void main(String[] args) {
        ...
        news.add(new News(1, "manoj", "manoj", "good budget"));
        news.add(new News(2, "rahul", "rahul", "not bad,really good"));
        news.add(new News(3, "bhavan", "bhavan", "too bad and must be improved budget"));
        news.add(new News(4, "poorva", "poorva", "very good budget"));
        ...
        transList.add(new Transaction(new Trader("manoj", "bangalore"), 2010, 5000));
        transList.add(new Transaction(new Trader("rahul", "Mumbai"), 2011, 15000));
        transList.add(new Transaction(new Trader("omkar", "Delhi"), 2012, 10000));
        transList.add(new Transaction(new Trader("bhavan", "pune"), 2011, 20000));
        transList.add(new Transaction(new Trader("poorva", "bangalore"), 2013, 25000));
